...
This project is **not** a “clone” of WSCAD/EPLAN/AutoCAD Electrical. The initial wedge is:

- **Automation-first deliverables** (BOM/wires/terminals/labels)
- **Deterministic validation** (rules + explainable fixes)
- **Local-first + web-first** (offline free tier, low friction)
- **Open/community parts library** with explicit verification levels

We will expand into richer drafting, panel layout, and collaboration **after** the core engine (model + rules + reports) is proven.
