...
const PROFESSIONAL: ThemeData = {
  ...
  pinDotColor: '#555555',
  pinDotRadius: 0.5,
  pinLabelColor: '#555555',
  tagColor: '#e0e0e0',
  tagFont: 'bold 3px monospace',
  partLabelColor: '#999999',
  partLabelFont: '2.5px monospace',
  wireWidth: 0.5,
  wireWidthSelected: 0.625,
  wireColors: ['#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA', '#8899AA'],
  wireLabelBg: 'rgba(0, 0, 0, 0.6)',
  wireLabelFont: '2px monospace',
  wireEndpointColor: '#555555',
  wireEndpointRadius: 0.5,
  wireEndpointSelectedColor: '#5B9BD5',
  wireEndpointSelectedRadius: 1.75,
  waypointFill: '#cc6600',
  waypointStroke: '#ffffff',
  waypointRadius: 1.25,
  selectionColor: '#5B9BD5',
  selectionWidth: 0.375,
  selectionDash: [1.5, 0.75],
  ...
  ladderRungGuideColor: 'rgba(255, 255, 255, 0.15)',
...
const BLUEPRINT: ThemeData = {
  ...
  wireLabelFont: 'bold 2.5px monospace',
  wireEndpointColor: '#8A7E6B',
  wireEndpointRadius: 1,
